// ArduinoISP
// This script is the ArduinoISP example but with some commented lines to permit to use the 10,11,12,13 pins instead of the hardware MOSI,MISO,SCK and RST pins of the Arduino Leonardo
//
